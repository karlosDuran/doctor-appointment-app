<x-admin-layout
    ...
    :breadcrumbs="[
        ...
        [
            'name' => 'Editar Aseguradora',
        ],
    ]">

    <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6">
            <p class="text-sm text-gray-600 mb-6">Actualiza la información de esta aseguradora aquí.</p>

            <form action="{{ route('admin.admin.insurances.update', $insurance) }}" method="POST">
                @csrf
                @method('PUT')
