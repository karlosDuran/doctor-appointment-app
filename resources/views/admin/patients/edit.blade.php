...
>
    ...
    <form action="{{ route('admin.admin.patients.update', $patient) }}" method="POST">
        ...
        {{-- ============================================================== --}}
        {{-- TABS DE NAVEGACIÓN (usando componentes reutilizables)          --}}
        {{-- ============================================================== --}}
        <x-wire-card>
            <x-tabs :active="$initialTab">

                {{-- ====== HEADER: Links de las pestañas ====== --}}
                <x-slot name="header">
                    {{-- Tab 1: Datos personales (sin errores de validación) --}}
                    ...
                    <x-tabs-link tab="informacion-general" :error="$errors->hasAny($errorGrupos['informacion-general'])">
                        <i class="fa-solid fa-info me-2"></i>
                        Información General
                    </x-tabs-link>

                    {{-- Tab 4: Contacto de emergencia --}}
                    <x-tabs-link tab="contacto-emergencia" :error="$errors->hasAny($errorGrupos['contacto-emergencia'])">
        ...
        {{-- ============================================================== --}}
        {{-- CÓDIGO ANTERIOR COMENTADO (tabs inline sin componentes)        --}}
        {{-- Se reemplazó por los componentes <x-tabs>, <x-tabs-link>       --}}
        {{-- y <x-tab-content> definidos arriba.                            --}}
        {{-- ============================================================== --}}
        {{--
        <x-wire-card>
            <div x-data="{ tab: '{{ $initialTab }}' }">
                ...
                @php $hasError = $errors->hasAny($errorGrupos['antecedentes']); @endphp
                <li class="me-2">
                ...
                @php $hasError = $errors->hasAny($errorGrupos['informacion-general']); @endphp
                <li class="me-2">
                ...
                @php $hasError = $errors->hasAny($errorGrupos['contacto-emergencia']); @endphp
                <li class="me-2">
